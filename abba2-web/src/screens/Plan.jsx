...
import { M, RATES, LTV } from '../lib/config.js';
    ...
    <>
      ...
      <div className="main fade cards" style={{ paddingBottom: 150 }}>
        ...
        <div className="card">
          ...
          <div className="muted">{a.goalType === 'house' ? `저축 목표(자기자본 ${Math.round((1 - LTV) * 100)}%) ${won(c.target)} · ` : ''}{monthsLabel} · 월 {won(a.saving)}{a.lump ? ` · 모아둔 ${won(a.lump)}` : ''}</div>
